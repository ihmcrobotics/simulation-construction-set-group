...
{
   /**
    * Name of the model as defined in the STL file. For ASCII format: Description following the solid
    * keyword For binary format: The first 80 bytes as ASCII, trimmed from whitespace
    *
    * @return model name
    */
