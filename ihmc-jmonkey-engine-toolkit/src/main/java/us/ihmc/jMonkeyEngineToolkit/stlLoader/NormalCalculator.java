 ...
 * Apparently, STL files do not always have normal data. Using primitive math for maximum
 * portability.
 *
 * @author Jesper Smith
 */
...
{
   /**
    * Calculate a normal vector based on three vertex coordinates that make up a triangle using the
    * right hand rule.
    *
   ...
   /**
    * Compare if two normals are within epsilon Normalizes both vectors in place
    *
