...
public interface RGBDStreamer
{
    ...
    * @param coordinates       Point coordinates. Ordered from Left to Right, Top to Bottom. Invalid
    *                          coordinates are set to Float.NaN. This array is re-used after this call
   ...
   /**
    * Get the nearest distance from the camera for measured points Return 0 to disable near clipping.
    * Note: The graphics engine might do its own clipping
    *
   ...
   /**
    * Get the farthest distance form the camera for returned measured points Return
    * Double.POSITIVE_INFINITY to disable far clipping. Note: The graphics engine might do its own
    * clipping
    *
    * @return Distance in meters
    */
