...
public class NetworkedPlotter
{
   ...
   public void add2dPoint(Point2D point2D)
   {
      ...
      {
         plotter.addArtifact(new PixelLineArtifact(String.valueOf(id++),
                                                   new Point2D(lastPoint.get().getX(), lastPoint.get().getY()),
                                                   new Point2D(point2D.getX(), point2D.getY()),
                                                   qualitativeColors.getColor(colorIndex),
                                                   2));
      }
      else
      {
         plotter.addArtifact(new PixelPointArtifact(String.valueOf(id++),
                                                    new Point2D(point2D.getX(), point2D.getY()),
                                                    qualitativeColors.getColor(colorIndex),
                                                    2));
      }
